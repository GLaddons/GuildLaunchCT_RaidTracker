function CT_RaidTracker_OptionsFrame_OnShow()
    ...
    CT_RaidTrackerOptionsFrameTabPage3AutoBossChangeMinTimeSlider:SetValue(CT_RaidTracker_Options["AutoBossChangeMinTime"]/1000);
...
function CT_RaidTracker_OptionsFrame_Save()
    ...
    if(CT_RaidTrackerOptionsFrameTabPage2AutoCreateRaidCB:GetChecked() == 1) then
        CT_RaidTracker_Options["AutoRaidCreation"] = 1;
    else
        CT_RaidTracker_Options["AutoRaidCreation"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage2LogGroupCB:GetChecked() == 1) then
        CT_RaidTracker_Options["LogGroup"] = 1;
    else
        CT_RaidTracker_Options["LogGroup"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage2AutoGroupCB:GetChecked() == 1) then
        CT_RaidTracker_Options["AutoGroup"] = 1;
    else
        CT_RaidTracker_Options["AutoGroup"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage2LogBattlefieldCB:GetChecked() == 1) then
        CT_RaidTracker_Options["LogBattlefield"] = 1;
    else
        CT_RaidTracker_Options["LogBattlefield"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage3AskWipeCB:GetChecked() == 1) then
    ...
    if(CT_RaidTrackerOptionsFrameTabPage3AskNextBossCB:GetChecked() == 1) then
    ...
    if(CT_RaidTrackerOptionsFrameTabPage2AutoZoneCB:GetChecked() == 1) then
        CT_RaidTracker_Options["AutoZone"] = 1;
    else
        CT_RaidTracker_Options["AutoZone"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage2NewRaidOnNewZoneCB:GetChecked() == 1) then
        CT_RaidTracker_Options["NewRaidOnNewZone"] = 1;
    else
        CT_RaidTracker_Options["NewRaidOnNewZone"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage3SaveExtendedPlayerInfoCB:GetChecked() == 1) then
        CT_RaidTracker_Options["SaveExtendedPlayerInfo"] = 1;
    else
        CT_RaidTracker_Options["SaveExtendedPlayerInfo"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage4SaveTooltipsCB:GetChecked() == 1) then
    ...
    CT_RaidTracker_Options["AutoBossChangeMinTime"] = CT_RaidTrackerOptionsFrameTabPage3AutoBossChangeMinTimeSlider:GetValue()*1000;
    CT_RaidTracker_Options["LogAttendees"] = CT_RaidTrackerOptionsFrameTabPage3LogAttendeesSlider:GetValue();
    if(CT_RaidTrackerOptionsFrameTabPage6TimeSyncCB:GetChecked() == 1) then
        CT_RaidTracker_Options["TimeSync"] = 1;
    else
        CT_RaidTracker_Options["TimeSync"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage6Use24hFormat:GetChecked() == 1) then
    ...
    if(CT_RaidTrackerOptionsFrameTabPage6GuildSnapshotCB:GetChecked() == 1) then
    ...
    --oberan added
    if(CT_RaidTrackerOptionsFrameTabPage4AutoSetEPGPCost:GetChecked() == 1) then
    	CT_RaidTracker_Options["AutoSetEPGPCost"] = 1;
    else
    	CT_RaidTracker_Options["AutoSetEPGPCost"] = 0;
    end
    if(CT_RaidTrackerOptionsFrameTabPage5DKPmonLoggingMode:GetChecked() == 1) then
        CT_RaidTracker_Options["DKPmonLoggingMode"] = 1;
    else
        CT_RaidTracker_Options["DKPmonLoggingMode"] = 0;
    end 
    -- ATTENDANCE
    if(CT_RaidTrackerOptionsFrameTabPage8EnableListme:GetChecked() == 1) then
        CT_RaidTracker_Options["ListMeEnabled"] = 1;
    else
        CT_RaidTracker_Options["ListMeEnabled"] = 0;
    end  
...
function CT_RaidTracker_OptionsFrame_ShowItemHelp(itemName)
    ...
    elseif (itemName == frameName ..  "TabPage3AutoBossChangeMinTimeSliderHelp") then
        tab_text = [[
            ...
            This options sets the period of time after the boss kill that all items 
            received by raid members will be atttributed to the boss that was killed. 
            ...
            time be set such as 600. The value is in seconds. If your guild takes a long 
            time to assign loot you can make it even higher.
